 ...
 *   firebase functions:config:set flutterwave.secret="FLWSECK_live-xxx" flutterwave.secrethash="your-webhook-hash"
 *
 * Or, with newer Node runtimes, use a .env file in /functions:
 *   FLW_SECRET_KEY=FLWSECK_live-xxx
 *   FLW_SECRET_HASH=your-webhook-hash
 * ------------------------------------------------------------
 */
...
const FLW_SECRET_KEY = functions.config().flutterwave ? functions.config().flutterwave.secret : process.env.FLW_SECRET_KEY;
const FLW_SECRET_HASH = functions.config().flutterwave ? functions.config().flutterwave.secrethash : process.env.FLW_SECRET_HASH;
...
/* =========================================================
 * 1) verifyPayment — called by the client right after Flutterwave's
 *    checkout callback fires, to confirm the charge really succeeded
...
/* =========================================================
 * 2) flutterwaveWebhook — the real source of truth for RECURRING billing.
 *    Point this URL at Flutterwave Dashboard > Settings > Webhooks, and
 *    set the same string as the dashboard's "Secret Hash" and
 *    FLW_SECRET_HASH here. Handles charge.completed (payment/renewal).
 * ========================================================= */
...
// tx_ref values look like "labguru-<uid>-<timestamp>"
